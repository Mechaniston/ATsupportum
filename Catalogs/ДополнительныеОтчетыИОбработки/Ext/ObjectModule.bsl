...
Процедура ПередУдалениемГлобальнойОбработки(Отказ)
	// Регламентные задание необходимо изменять в неразделенном режиме.
	УстанавливатьПривилегированныйРежим = УстанавливатьПривилегированныйРежим();
...
Функция УстанавливатьПривилегированныйРежим()
	...
	Возврат РольДоступна(Метаданные.Роли.ДобавлениеИзменениеДополнительныхОтчетовИОбработок)
...
Процедура ПриЗаписиГлобальногоОтчета(Отказ)
	...
	Если ОбщегоНазначенияКлиентСервер.ПодсистемаСуществует("СтандартныеПодсистемы.ВариантыОтчетов") Тогда
		...
		МодульВариантыОтчетов.ОбработкаВариантовДополнительногоОтчета(ЭтотОбъект, Отказ, ВнешнийОбъект);
