...
Процедура ПередЗаписью(Отказ)
	...
	Если ОбменДанными.Загрузка Тогда
		Если ЗначениеЗаполнено(ОбменДанными.Отправитель) Тогда
			ВосстановитьСоставУчастниковГруппыДоступаАдминистраторы();
		КонецЕсли;
		Возврат;
	КонецЕсли;
	
	Если ДополнительныеСвойства.Свойство("НезависимоеИзменениеОбъекта")
...
Процедура ВосстановитьСоставУчастниковГруппыДоступаАдминистраторы()
	
	Если Ссылка = Справочники.ГруппыДоступа.Администраторы Тогда
		
		// Состав участников группы доступа Администраторы
		// настраивается отдельно в каждой информационной базе.
		
		ЭтотОбъект.Пользователи.Очистить();
		
		Для каждого Строка Из Ссылка.Пользователи Цикл
			ЭтотОбъект.Пользователи.Добавить().Пользователь = Строка.Пользователь;
		КонецЦикла;
