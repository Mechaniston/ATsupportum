...
//
// ПолучениеЭлемента – Тип: ПолучениеЭлементаДанных.
// Значение данного параметра может быть переопределено в обработчике.
// Определяет, будет ли прочитанный элемент данных записан в базу данных или нет в случае коллизии.
...
//
// Отправитель – Тип: ПланОбменаСсылка. Узел плана обмена, от имени которого выполняется получение данных.
//
// ПолучениеОтГлавного – Тип: Булево.
// В распределенной информационной базе обозначает признак получения данных от главного узла.
