...
// Возвращает значение свойства Линия системного перечисления ОтображениеОбычнойГруппы.
//
// Возвращаемое значение:
//   ОтображениеОбычнойГруппы - Линия для 8.2 и СлабоеВыделение для 8.3.
//
Функция ОтображениеОбычнойГруппыЛиния() Экспорт
	...
	Иначе
		Возврат ОтображениеОбычнойГруппы["Линия"];
	КонецЕсли;
	
КонецФункции

// Возвращает значение свойства Отступ системного перечисления ОтображениеОбычнойГруппы.
//
// Возвращаемое значение:
//   ОтображениеОбычнойГруппы - Отступ для 8.2 и ОбычноеВыделение для 8.3.
//
Функция ОтображениеОбычнойГруппыОтступ() Экспорт
	...
	Иначе
		Возврат ОтображениеОбычнойГруппы["Отступ"];
	КонецЕсли;
	
КонецФункции

// Возвращает значение свойства РамкаГруппы системного перечисления ОтображениеОбычнойГруппы.
//
// Возвращаемое значение:
//   ОтображениеОбычнойГруппы - РамкаГруппы для 8.2 и СильноеВыделение для 8.3.
//
Функция ОтображениеОбычнойГруппыРамкаГруппы() Экспорт
	...
	Иначе
		Возврат ОтображениеОбычнойГруппы["РамкаГруппы"];
	КонецЕсли;
...
//       "ПланВидовХарактеристик.ВидыДоступа.ВнешниеПользователи"
//       "ПланСчетов.Хозрасчетный.Материалы"
//       "ПланВидовРасчета.Начисления.ОплатаПоОкладу"
//
// Возвращаемое значение: 
//   Ссылка предопределенного элемента или Неопределено если элемент не найден.
//
Функция ПредопределенныйЭлемент(ПолноеИмяПредопределенного) Экспорт
	Если ВРег(Прав(ПолноеИмяПредопределенного, 13)) = ".ПУСТАЯССЫЛКА" // Для получения пустых ссылок.
		ИЛИ НЕ ЭтоПлатформа83БезРежимаСовместимости() Тогда           // А также в версии 8.2 или 8.3 в режиме совместимости с 8.2.
		Возврат ПредопределенноеЗначение(ПолноеИмяПредопределенного); // Используется стандартная функция платформы.
	КонецЕсли;
