...
Процедура ПриОткрытии(Отказ)
	...
	Элементы.Заявка.Видимость = (ВладелецФормы = Неопределено);
...
Процедура СписокПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель, Группа, Параметр)
	...
	ОткрытьФорму("Документ.Согласование_ат.ФормаОбъекта", Новый Структура("Основание", Параметры.Заявка), ЭтаФорма);
