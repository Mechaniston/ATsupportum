...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	//ОткрытьФорму("Документ.Согласование_ат.ФормаСписка", ПараметрыФормы,
	...
	ИначеЕсли 	ТипЗнч(ПараметрКоманды) = Тип("ДокументСсылка.Задание_ат") Тогда
		...
		ПараметрИмя = "Ссылка"; //Ссылка.ОбъектыСогласования.Задание
		Задание = ПараметрКоманды;
		ПараметрКоманды = Согласование_ат.ПолучитьМассивСогласованийПоЗаданию(ПараметрКоманды);
