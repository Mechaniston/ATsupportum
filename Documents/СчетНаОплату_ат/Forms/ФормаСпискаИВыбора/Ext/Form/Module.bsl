...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Список.Параметры.УстановитьЗначениеПараметра("ТипСтатуса", Перечисления.ТипыСтатусовОтправкиФинДокументов_ат.ФинальныйПоложительный);
...
&НаКлиенте
Процедура ОбновитьДанныеОПоступлениях(Команда)
	
	ОбновитьДанныеОПоступленияхНаСервере();
...
Процедура ОбновитьДанныеОПоступленияхНаСервере()
	
	МассивОшибок = СинхронизацияСБП_ат.ОбновитьДанныеОплатыСчетов();
