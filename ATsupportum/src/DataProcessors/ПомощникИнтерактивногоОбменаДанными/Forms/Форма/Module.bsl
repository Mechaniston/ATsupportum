...
//         РасширенныйРежимДополненияВыгрузки – Булево           - флаг включения механизма настройки дополнения выгрузки по сценарию узла
//
// Вариант 2:
//     Параметры: 
//         УзелИнформационнойБазы             – ПланОбменаСсылка - плана обмена, для которого выполняется помощник
//         РасширенныйРежимДополненияВыгрузки – Булево           - флаг включения механизма настройки дополнения выгрузки по сценарию узла
//         ИмяПланаОбмена                     – Строка           - имя менеджера плана обмена  которого используется для поиска
...
Процедура ДополнениеВыгрузкиОтборПоСценариюУзла(Команда)
	ОбменДаннымиКлиент.ОткрытьФормуДополненияВыгрузкиСценарийУзла(ДополнениеВыгрузки, ЭтаФорма);
КонецПроцедуры
...
Процедура УдалитьВременныйКаталогСообщенийОбмена(ИмяВременногоКаталога)
	...
	Если Не ПустаяСтрока(ИмяВременногоКаталога) Тогда
		...
		Исключение
			ЗаписьЖурналаРегистрации(НСтр("ru = 'Обмен данными.Удаление временных файлов'"),
...
Процедура АнализДанных()
	...
	Попытка
		...
		Если ОбщегоНазначения.ИнформационнаяБазаФайловая() Тогда
			...
			РезультатАнализа = Обработки.ПомощникИнтерактивногоОбменаДанными.РезультатАвтоматическогоСопоставленияДанных(
				Объект.УзелИнформационнойБазы,
				Объект.ИмяФайлаСообщенияОбмена,
				Объект.ИмяВременногоКаталогаСообщенийОбмена
			);
			
			ПослеАнализаДанных(РезультатАнализа);
...
Функция Подключаемый_СтраницаИнформацииСтатистики_ПриПереходеДалее(Отказ)
	...
	Если Не ВсеДанныеСопоставлены Тогда
		...
		Ответ = Вопрос(Сообщение, Кнопки,, КодВозвратаДиалога.Да);
...
Процедура ЗагрузкаДанных()
	...
	Исключение
		...
		УдалитьВременныйКаталогСообщенийОбмена(Объект.ИмяВременногоКаталогаСообщенийОбмена);
		ЗаписатьОшибкуВЖурналРегистрации(ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()),
			НСтр("ru = 'Помощник интерактивного обмена данными.Загрузка данных'")
		);
		Возврат;
	КонецПопытки;
...
Процедура ИнициализироватьРеквизитыДополненияВыгрузки()
	...
	НастройкиДополненияВыгрузки = ОбменДаннымиСервер.ИнтерактивноеИзменениеВыгрузки(
		Объект.УзелИнформационнойБазы, ЭтаФорма.УникальныйИдентификатор, ДополнениеВыгрузкиРасширенныйРежим);
...
Процедура ПолучениеДанныхЧерезОбычныеКаналыСвязи()
	...
	// Получение данных (транспорт сообщения обмена)
	ТаблицаПереходовНоваяСтрока(2, "СтраницаОжиданияАнализаДанных", "СтраницаНавигацииОжидание",,,,, Истина, "СтраницаОжиданияАнализаДанных_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(3, "СтраницаОжиданияАнализаДанных", "СтраницаНавигацииОжидание",,,,, Истина, "СтраницаОжиданияАнализаДанныхДлительнаяОперация_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(4, "СтраницаОжиданияАнализаДанных", "СтраницаНавигацииОжидание",,,,, Истина, "СтраницаОжиданияАнализаДанныхДлительнаяОперацияОкончание_ОбработкаДлительнойОперации");
	
	// Анализ данных
	// Автоматическое сопоставление данных
	ТаблицаПереходовНоваяСтрока(5, "СтраницаОжиданияАнализаДанных", "СтраницаНавигацииОжидание",,,,, Истина, "АнализДанных_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(6, "СтраницаОжиданияАнализаДанных", "СтраницаНавигацииОжидание",,,,, Истина, "АнализДанныхДлительнаяОперация_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(7, "СтраницаОжиданияАнализаДанных", "СтраницаНавигацииОжидание",,,,, Истина, "АнализДанныхДлительнаяОперацияОкончание_ОбработкаДлительнойОперации");
	...
	// Загрузка данных
	ТаблицаПереходовНоваяСтрока(9,  "СтраницаОжиданияСинхронизацииДанных", "СтраницаНавигацииОжидание",,,,, Истина, "ЗагрузкаДанных_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(10, "СтраницаОжиданияСинхронизацииДанных", "СтраницаНавигацииОжидание",,,,, Истина, "ЗагрузкаДанныхДлительнаяОперация_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(11, "СтраницаОжиданияСинхронизацииДанных", "СтраницаНавигацииОжидание",,,,, Истина, "ЗагрузкаДанныхДлительнаяОперацияОкончание_ОбработкаДлительнойОперации");
...
Процедура ПолучениеДанныхЧерезВнешнееСоединениеИлиВебСервис()
	...
	ТаблицаПереходовНоваяСтрока(1, "СтраницаНачала",                     "СтраницаНавигацииНачало",,, "СтраницаНачала_ПриПереходеДалее");
	ТаблицаПереходовНоваяСтрока(2, "СтраницаОжиданияАнализаДанных",      "СтраницаНавигацииОжидание",,,,, Истина, "СтраницаОжиданияПроверкиПодключения_ОбработкаДлительнойОперации");
	
	// Получение данных (транспорт сообщения обмена)
	ТаблицаПереходовНоваяСтрока(3, "СтраницаОжиданияАнализаДанных", "СтраницаНавигацииОжидание",,,,, Истина, "СтраницаОжиданияАнализаДанных_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(4, "СтраницаОжиданияАнализаДанных", "СтраницаНавигацииОжидание",,,,, Истина, "СтраницаОжиданияАнализаДанныхДлительнаяОперация_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(5, "СтраницаОжиданияАнализаДанных", "СтраницаНавигацииОжидание",,,,, Истина, "СтраницаОжиданияАнализаДанныхДлительнаяОперацияОкончание_ОбработкаДлительнойОперации");
	
	// Анализ данных
	// Автоматическое сопоставление данных
	ТаблицаПереходовНоваяСтрока(6, "СтраницаОжиданияАнализаДанных", "СтраницаНавигацииОжидание",,,,, Истина, "АнализДанных_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(7, "СтраницаОжиданияАнализаДанных", "СтраницаНавигацииОжидание",,,,, Истина, "АнализДанныхДлительнаяОперация_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(8, "СтраницаОжиданияАнализаДанных", "СтраницаНавигацииОжидание",,,,, Истина, "АнализДанныхДлительнаяОперацияОкончание_ОбработкаДлительнойОперации");
	...
	// Загрузка данных
	ТаблицаПереходовНоваяСтрока(10, "СтраницаОжиданияСинхронизацииДанных", "СтраницаНавигацииОжидание",,,,, Истина, "ЗагрузкаДанных_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(11, "СтраницаОжиданияСинхронизацииДанных", "СтраницаНавигацииОжидание",,,,, Истина, "ЗагрузкаДанныхДлительнаяОперация_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(12, "СтраницаОжиданияСинхронизацииДанных", "СтраницаНавигацииОжидание",,,,, Истина, "ЗагрузкаДанныхДлительнаяОперацияОкончание_ОбработкаДлительнойОперации");
...
Процедура ОтправкаДанныхЧерезОбычныеКаналыСвязи()
	...
	// Выгрузка данных
	ТаблицаПереходовНоваяСтрока(3, "СтраницаОжиданияСинхронизацииДанных", "СтраницаНавигацииОжидание",,,,, Истина, "СтраницаОжиданияВыгрузкиДанных_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(4, "СтраницаОжиданияСинхронизацииДанных", "СтраницаНавигацииОжидание",,,,, Истина, "СтраницаОжиданияВыгрузкиДанныхДлительнаяОперация_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(5, "СтраницаОжиданияСинхронизацииДанных", "СтраницаНавигацииОжидание",,,,, Истина, "СтраницаОжиданияВыгрузкиДанныхДлительнаяОперацияОкончание_ОбработкаДлительнойОперации");
...
Процедура ОтправкаДанныхЧерезВнешнееСоединениеИлиВебСервис()
	...
	// Проверка подключения
	ТаблицаПереходовНоваяСтрока(1, "СтраницаНачала",                      "СтраницаНавигацииНачало",,, "СтраницаНачала_ПриПереходеДалее");
	ТаблицаПереходовНоваяСтрока(2, "СтраницаОжиданияСинхронизацииДанных", "СтраницаНавигацииОжидание",,,,, Истина, "СтраницаОжиданияПроверкиПодключения_ОбработкаДлительнойОперации");
	...
	// Выгрузка данных
	ТаблицаПереходовНоваяСтрока(4, "СтраницаОжиданияСинхронизацииДанных", "СтраницаНавигацииОжидание",,,,, Истина, "СтраницаОжиданияВыгрузкиДанных_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(5, "СтраницаОжиданияСинхронизацииДанных", "СтраницаНавигацииОжидание",,,,, Истина, "СтраницаОжиданияВыгрузкиДанныхДлительнаяОперация_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(6, "СтраницаОжиданияСинхронизацииДанных", "СтраницаНавигацииОжидание",,,,, Истина, "СтраницаОжиданияВыгрузкиДанныхДлительнаяОперацияОкончание_ОбработкаДлительнойОперации");
...
Процедура ПолучениеИОтправкаДанныхЧерезОбычныеКаналыСвязи()
	...
	// Выгрузка данных
	ТаблицаПереходовНоваяСтрока(13, "СтраницаОжиданияСинхронизацииДанных", "СтраницаНавигацииОжидание",,,,, Истина, "СтраницаОжиданияВыгрузкиДанных_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(14, "СтраницаОжиданияСинхронизацииДанных", "СтраницаНавигацииОжидание",,,,, Истина, "СтраницаОжиданияВыгрузкиДанныхДлительнаяОперация_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(15, "СтраницаОжиданияСинхронизацииДанных", "СтраницаНавигацииОжидание",,,,, Истина, "СтраницаОжиданияВыгрузкиДанныхДлительнаяОперацияОкончание_ОбработкаДлительнойОперации");
...
Процедура ПолучениеИОтправкаДанныхЧерезВнешнееСоединениеИлиВебСервис()
	...
	// Выгрузка данных
	ТаблицаПереходовНоваяСтрока(14, "СтраницаОжиданияСинхронизацииДанных", "СтраницаНавигацииОжидание",,,,, Истина, "СтраницаОжиданияВыгрузкиДанных_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(15, "СтраницаОжиданияСинхронизацииДанных", "СтраницаНавигацииОжидание",,,,, Истина, "СтраницаОжиданияВыгрузкиДанныхДлительнаяОперация_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(16, "СтраницаОжиданияСинхронизацииДанных", "СтраницаНавигацииОжидание",,,,, Истина, "СтраницаОжиданияВыгрузкиДанныхДлительнаяОперацияОкончание_ОбработкаДлительнойОперации");
