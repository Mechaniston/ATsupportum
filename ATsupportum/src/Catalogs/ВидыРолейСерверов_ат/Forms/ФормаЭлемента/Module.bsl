...
Процедура УправлениеФормой()
	...
	Если ПустаяСтрока(Объект.Наименование) Или 
		(Не Объект.Ссылка.Пустая() И Объект.Ссылка.Наименование = Строка(Объект.Ссылка.ТипРолиСервера)) Тогда
		
		Объект.Наименование = Строка(Объект.ТипРолиСервера);
...
&НаКлиенте
Процедура ТипРолиСервераПриИзменении(Элемент)
