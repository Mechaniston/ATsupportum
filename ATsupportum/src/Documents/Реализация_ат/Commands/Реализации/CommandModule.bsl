...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	Если 		ТипЗнч(ПараметрКоманды) = Тип("ДокументСсылка.СчетНаОплату_ат") Тогда
		
		ПараметрИмя = "Ссылка.СчетаНаОплату.СчетНаОплату";
	...
	ИначеЕсли 	ТипЗнч(ПараметрКоманды) = Тип("СправочникСсылка.Договоры_ат") Тогда
		...
		Если ЭтоОсновнойДоговор(ПараметрКоманды) Тогда
			ПараметрИмя = "ОсновнойДоговор";
		Иначе
			ПараметрИмя = "Договор";
		КонецЕсли; 
	...
	ОткрытьФорму("Документ.Реализация_ат.ФормаСписка", ПараметрыФормы,
...
&НаСервере
Функция   ЭтоОсновнойДоговор(Договор)
	
	Возврат Договор.Родитель.Пустая();
