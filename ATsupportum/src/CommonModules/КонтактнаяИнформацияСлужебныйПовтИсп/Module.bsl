...
// Преобразует список значений, оставляя из него только последние значения пар ключ-значение
//
// Результат преобразования - строка XML сериализованного списка значений
//
...
//
//    Результат преобразования - сериализованный ValueTable (http://v8.1c.ru/8.1/data/core), в котором три колонки:
...
//
// Результат преобразования - строка XML сериализованной структуры
//
...
//
// Результат преобразования - строка результата
//
...
//
// Результат преобразования - сериализованная структура
//
...
//
// Результат преобразования - сериализованный список значений
//
...
// Преобразует контактную информацию в виде XML (см пакет XDTO КонтактнаяИнформация) в перечисление ТипКонтакнойИнформации
//
// Результат преобразования - сериализованное значение перечисления
//
...
// Преобразует таблицу различий XML в зависимости от типа контактной информации
//
// Параметры:
//    ТипКонтактнойИнформации - значение или имя перечисления
//
//    Результат преобразования - сериализованный ValueTable (http://v8.1c.ru/8.1/data/core), в котором три колонки:
//       - Путь      - строка - путь к месту различия
//       - Описание  - строка - описание отличающегося реквизита в терминах предметной области
//       - Значение1 - строка - значение из первого XML
//       - Значение2 - строка - значение из второго XML
//
