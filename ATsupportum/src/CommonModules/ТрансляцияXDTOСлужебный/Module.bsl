...
Функция ВыполнитьТрансляцию(Знач ИсходныйОбъект, Знач ОписаниеИсходнойВерсии, Знач ОписаниеРезультирующейВерсии) Экспорт
	...
	Иначе
		...
		ТаблицаТрансляцииИнтерфейса.Колонки.Добавить("Ключ");
		ТаблицаТрансляцииИнтерфейса.Колонки.Добавить("Значение");
		ТаблицаТрансляцииИнтерфейса.Колонки.Добавить("ВерсияЧислом");
		...
		Для Каждого ЭтапТрансляцииИнтерфейса Из ЦепочкаТрансляцииИнтерфейса Цикл
			...
			Для Каждого Разряд Из Разряды Цикл
				...
				ВерсияЧислом = ВерсияЧислом + Число(Разряд) * (Разряды.Количество() - Итератор * 1000);
				Итератор = Итератор + 1;
		...
		ТаблицаТрансляцииИнтерфейса.Сортировать("ВерсияЧислом Возр");
