...
Процедура УстановитьФлагАктивностиПользователяВОбласти() Экспорт
	...
	Если НЕ ОбщегоНазначенияПовтИсп.ЭтоРазделеннаяКонфигурация()
		...
		ИЛИ НЕ ПолучитьФункциональнуюОпцию("ПоддержкаРезервногоКопирования") Тогда
...
Процедура СозданиеКопий(Знач ПараметрыСоздания, Знач СостояниеСоздания) Экспорт
	...
	ПараметрыБлокировки.Сообщение = НСтр("ru = 'Выполняется создание резервной копии приложения. Настройки резервного копирования могут быть изменены в менеджере сервиса.'");
