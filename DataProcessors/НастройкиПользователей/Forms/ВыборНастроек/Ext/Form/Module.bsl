...
Процедура ОбновитьЗаголовокСтраницы(КоличествоНастроек)
	...
	Если ВыбраннаяСтраницаНастроек = "НастройкиОтчетовСтраница" Тогда
		...
		ТекстЗаголовка = ?(КоличествоНастроекОтчетов = 0, НСтр("ru='Настройки отчетов'"), НСтр("ru='Настройки отчетов (%1)'"));
	...
	ИначеЕсли ВыбраннаяСтраницаНастроек = "ВнешнийВидСтраница" Тогда
		...
		ТекстЗаголовка = ?(КоличествоНастроекВнешнегоВида = 0, НСтр("ru='Внешний вид'"), НСтр("ru='Внешний вид (%1)'"));
	...
	ИначеЕсли ВыбраннаяСтраницаНастроек = "ПрочиеНастройкиСтраница" Тогда
		...
		ТекстЗаголовка = ?(КоличествоПрочихНастроек = 0, НСтр("ru='Прочие настройки'"), НСтр("ru='Прочие настройки (%1)'"));
...
Функция ВыбранныеНастройки(ДеревоНастроек)
	...
	Для Каждого Настройка Из ДеревоНастроек.ПолучитьЭлементы() Цикл
		...
		Если Настройка.Пометка = 1 Тогда
			...
			ИначеЕсли Настройка.Тип = "ПользовательскаяНастройка" Тогда
				ПрочиеПользовательскиеНастройки.Добавить(Настройка.Ключи);
			Иначе
