...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ВариантыОтбораСтатусаСопоставления.Вставить(СписокВыбора.Добавить(
		"ВсеОбъекты", НСтр("ru='Все данные'")
	).Значение, Новый ФиксированнаяСтруктура);
	
	ВариантыОтбораСтатусаСопоставления.Вставить(СписокВыбора.Добавить(
		"СопоставленныеОбъектыНеутвержденные", НСтр("ru='Изменения'"),
	).Значение, Новый ФиксированнаяСтруктура("СтатусСопоставления",  3));
	
	ВариантыОтбораСтатусаСопоставления.Вставить(СписокВыбора.Добавить(
		"СопоставленныеОбъекты", НСтр("ru='Сопоставленные данные'"),,
	).Значение, Новый ФиксированнаяСтруктура("СтатусСопоставленияДополнительный", 0));
	
	ВариантыОтбораСтатусаСопоставления.Вставить(СписокВыбора.Добавить(
		"НесопоставленныеОбъекты", НСтр("ru='Несопоставленные данные'"),
	).Значение, Новый ФиксированнаяСтруктура("СтатусСопоставленияДополнительный", 1));
	
	ВариантыОтбораСтатусаСопоставления.Вставить(СписокВыбора.Добавить(
		"НесопоставленныеОбъектыПриемника", НСтр("ru='Несопоставленные данные этой базы'"),
	).Значение, Новый ФиксированнаяСтруктура("СтатусСопоставления",  1));
	
	ВариантыОтбораСтатусаСопоставления.Вставить(СписокВыбора.Добавить(
		"НесопоставленныеОбъектыИсточника", НСтр("ru='Несопоставленные данные второй базы'"),
	).Значение, Новый ФиксированнаяСтруктура("СтатусСопоставления", -1));
...
Процедура ОбработкаВыбора(ВыбранноеЗначение, ИсточникВыбора)
	...
	Если ВРег(ИсточникВыбора.ИмяФормы) = ВРег("Обработка.СопоставлениеОбъектовИнформационныхБаз.Форма.НастройкаАвтоматическогоСопоставления") Тогда
		...
		ОткрытьФорму("Обработка.СопоставлениеОбъектовИнформационныхБаз.Форма.РезультатАвтоматическогоСопоставления", ПараметрыФормы, ЭтаФорма);
...
Процедура ВыполнитьАвтоматическоеСопоставление(Команда)
	...
	ОткрытьФорму("Обработка.СопоставлениеОбъектовИнформационныхБаз.Форма.НастройкаАвтоматическогоСопоставления", ПараметрыФормы, ЭтаФорма);
...
Процедура ИзменитьПоляТаблицы(Команда)
	...
	ОткрытьФорму("Обработка.СопоставлениеОбъектовИнформационныхБаз.Форма.НастройкаПолейТаблицы", ПараметрыФормы, ЭтаФорма);
...
Процедура НастройкаСпискаПолейТаблицы(Команда)
	...
	ОткрытьФорму("Обработка.СопоставлениеОбъектовИнформационныхБаз.Форма.НастройкаПолейТаблицыСопоставления", ПараметрыФормы, ЭтаФорма);
...
Процедура Сортировка(Команда)
	...
	ОткрытьФорму("Обработка.СопоставлениеОбъектовИнформационныхБаз.Форма.НастройкаСортировки", ПараметрыФормы, ЭтаФорма);
...
Процедура УстановитьСвязьИнтерактивно()
	...
	ОткрытьФорму("Обработка.СопоставлениеОбъектовИнформационныхБаз.Форма.ФормаВыбораСвязиСопоставления", ПараметрыФормы, ЭтаФорма);
КонецПроцедуры
...
Функция УстановитьСвязьБыстро()
	...
	ДобавитьНеутвержденноеСопоставлениеНаКлиенте(Идентификатор1, Идентификатор2);
	ТекущийЭлемент = Элементы.ТаблицаСопоставления;
...
Процедура ДобавитьНеутвержденноеСопоставлениеНаКлиенте(Знач ИдентификаторСтрокиНачала, Знач ИдентификаторСтрокиОкончания)
	...
	// Пполучаем две сопоставленные строки таблицы по указанным идентификаторам
...
Процедура ВыполнитьСопоставлениеОбъектов(Отказ)
	...
	Исключение
		Отказ = Истина;
		ЗаписьЖурналаРегистрации(НСтр("ru = 'Помощник сопоставления объектов.Анализ данных'"),
