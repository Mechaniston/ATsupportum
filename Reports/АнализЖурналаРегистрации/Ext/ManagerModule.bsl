...
Функция ДанныеИзЖурналаРегистрации(ПараметрыОтчета) Экспорт
	...
	Возврат Новый Структура("АнализАктивностиПользователей, ОдновременноСессий", 
   							ИсходныеДанные, ОдновременноСессий);  
КонецФункции
...
Функция СформироватьОтчетПоПродолжительностиРаботыРегламентныхЗаданий(ПараметрыЗаполнения) Экспорт
	...
	Если ОбщегоНазначения.ИнформационнаяБазаФайловая() Тогда
		Отчет.Вывести(Макет.ПолучитьОбласть("Предупреждение"));
	КонецЕсли;
